    ...
    <div class="container">
        ...
        <div class="main-container">
            <form action="process_form.php" method="post">
                ...
                <input type="hidden" name="regulation" value="<?php echo $regulation ?>">
                ...
                <textarea name="suggestion" id="suggestion" cols="100" rows="2" placeholder="Give any suggetion"></textarea>
                <div class="btn-class">
